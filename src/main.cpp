...
void handleRoot(){
  ...
  page += "                       <input type='number' id='inputFirstHour' name='inputFirstHour' style='width: 50px;' min='0' max='23'><br>";
  page += "                       <label for='inputNumber'>Minute :</label>";
  page += "                       <input type='number' id='inputFirstMinute' name='inputFirstMinute' style='width: 50px; margin-bottom: 10px;' min='0' max='59'><br>";
  ...
  page += "                       <label for='inputNumber'>Hour :&nbsp;&nbsp;&nbsp;&nbsp;</label>";
  page += "                       <input type='number' id='inputSecondHour' name='inputSecondHour' style='width: 50px;' min='0' max='23'><br>";
  page += "                       <label for='inputNumber'>Minute :</label>";
  page += "                       <input type='number' id='inputSecondMinute' name='inputSecondMinute' style='width: 50px; margin-bottom: 10px;' min='0' max='59'><br>";
  ...
  page += "                       <label for='inputNumber'>Hour :&nbsp;&nbsp;&nbsp;&nbsp;</label>";
  page += "                       <input type='number' id='inputThirdHour' name='inputThirdHour' style='width: 50px;' min='0' max='23'><br>";
  page += "                       <label for='inputNumber'>Minute :</label>";
  page += "                       <input type='number' id='inputThirdMinute' name='inputThirdMinute' style='width: 50px; margin-bottom: 10px;' min='0' max='59'><br>";
  page += "                       <input type='submit' value='Submit' style='font-size: 20px; background-color: cadetblue; border-radius: 5px; padding: 5%; color: blanchedalmond;'>";
  page += "                     </form>";
  page += "                   </td>";
  page += "                   <td>";
  ...
  page += "                       <label for='inputNumber'>Hour :&nbsp;&nbsp;&nbsp;&nbsp;</label>";
  page += "                       <input type='number' id='inputFourthHour' name='inputFourthHour' style='width: 50px;' min='0' max='23'><br>";
  page += "                       <label for='inputNumber'>Minute :</label>";
  page += "                       <input type='number' id='inputFourthMinute' name='inputFourthMinute' style='width: 50px; margin-bottom: 10px;' min='0' max='59'><br>";
  page += "                       <input type='submit' value='Submit' style='font-size: 20px; background-color: cadetblue; border-radius: 5px; padding: 5%; color: blanchedalmond;'>";
  page += "                     </form>";
  page += "                 </tr>";
  page += "                 <tr>";
